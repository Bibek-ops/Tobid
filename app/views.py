...
class ProductView(View):
    def get(self, request):
        streetwears = Product.objects.filter(category='SW')
        shoes = Product.objects.filter(category='S')
        mobiles = Product.objects.filter(category='M')
        return render(request, 'app/home.html', {'streetwears':streetwears, 'shoes':shoes, 'mobiles':mobiles})
...
class CustomerRegistrationView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            messages.success(request, 'congrualitions!!Registration successful')
            form.save()
        return render(request, 'app/customerregistration.html', {'form':form})
...
class ProfileView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            reg.save()
            messages.success(request, 'Congratulations!! Proifle Updated Successfully')
        return render(request, 'app/profile.html', {'form':form,'active':'btn-primary'})